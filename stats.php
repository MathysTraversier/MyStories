            ...
            <div class="row mt-5">
                ...
                <div class="col-7 text-start">
                    ...
                    <p class="pb-4"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trophy" viewBox="0 0 16 16">
                        ...
                        </svg> Pourcentage de réussite de l'histoire : <?= $data['sto_success'] / $data['sto_played'] * 100 ?> %</p>
                    <p><img src="images/poison.png" alt="dead" class="float-start" width="16" /> Pourcentage d'échec dans l'histoire : <?= 100 - $data['sto_success'] / $data['sto_played'] * 100 ?> %</p>
                </div>
            </div>
        </div>
    </div>
